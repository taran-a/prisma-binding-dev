...
function makePrismaLink(_a) {
    ...
    //@ts-ignore
    wsLink.subscriptionClient.onConnected(function () {
        console.log(Date.now(), 'link.js', 'onConnected');
    });
    //@ts-ignore
    wsLink.subscriptionClient.onDisconnected(function () {
        console.log(Date.now(), 'link.js', 'onDisconnected');
    });
    //@ts-ignore
    wsLink.subscriptionClient.onError(function () {
        var args = [];
    ...
    //@ts-ignore
    wsLink.subscriptionClient.onReconnecting(function () {
        console.log(Date.now(), 'link.js', 'onReconnecting');
    });
    //@ts-ignore
    wsLink.subscriptionClient.onReconnected(function () {
